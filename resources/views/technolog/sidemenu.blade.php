...
<a href="/technolog/home" class="list-group-item list-group-item-action bg-transparent second-text"><i class="fas fa-tachometer-alt me-2"></i>Bosh sahifa</a>
    ...
    <a href="/technolog/seeregions" class="list-group-item list-group-item-action bg-transparent second-text fw-bold {{Request::is('technolog/seeregions') ? 'active' : null }}"><i class="fas fa-map-marker-alt"></i> Regions</a>
    <a href="/technolog/seekingardens" class="list-group-item list-group-item-action bg-transparent second-text fw-bold {{Request::is('technolog/seekingardens') ? 'active' : null }}"><i class="fas fa-map-marker-alt"></i> Kingardens</a>
